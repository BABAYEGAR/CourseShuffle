...
namespace CourseShuffle.Data.Service.FileUploader
{
    /// <summary>
    ...
    public class FileUploader
    {
        ...
        public string UploadFile(HttpPostedFileBase fileUpload, string uploadType)
        {
            ...
            if (fileUpload != null)
            {
                ...
                if ((fileInfo.Extension.ToLower() == ".jpg") || (fileInfo.Extension.ToLower() == ".jpeg")
                    || (fileInfo.Extension.ToLower() == ".png") || (fileInfo.Extension.ToLower() == ".pdf"))
                    try
                    {
